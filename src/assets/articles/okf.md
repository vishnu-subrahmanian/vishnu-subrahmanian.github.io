Google published a new spec for how AI agents should consume structured knowledge - markdown files with YAML frontmatter, linked to each other like a wiki, no database, no vendor.
...
*Full code on [GitHub](https://github.com/vishnu-subrahmanian/okf)*